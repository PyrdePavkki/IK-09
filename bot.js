...
bot.on('message', (msg) => {
if (channel.includes(msg.channel.id) && Object.values(unverified).includes(msg.member.roles.cache) && msg.content.startsWith("\"")) { 
...
} else if (channel.includes(msg.channel.id) && Object.values(unverified).includes(msg.member.roles.cache) && msg.content.startsWith("CT-")) {
